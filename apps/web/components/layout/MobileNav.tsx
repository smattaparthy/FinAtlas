...
const mobileNavItems: MobileNavItem[] = [
  ...
  { href: '/investments', label: 'Invest', icon: InvestmentIcon },
  { href: '/assistant', label: 'AI', icon: AssistantIcon },
...
export function MobileNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 lg:hidden z-50 pb-[env(safe-area-inset-bottom)]"
      style={{
        ...
        {mobileNavItems.map((item) => {
          ...
          return (
            <Link
              ...
              style={{
                color: isActive ? `rgb(var(--accent-primary))` : `rgb(var(--text-tertiary))`,
              }}
            >
