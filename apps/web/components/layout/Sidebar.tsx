...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/spending-trends", label: "Trends", icon: TrendsIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/amortization", label: "Amortization", icon: AmortizationIcon },
      { href: "/debt-payoff", label: "Debt Payoff", icon: DebtPayoffIcon },
      { href: "/refinance", label: "Refinance", icon: RefinanceIcon },
    ],
  },
  {
    label: "Planning",
    items: [
      ...
      { href: "/goal-planner", label: "Goal Planner", icon: GoalPlannerIcon },
...
function RebalancingIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
function AmortizationIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
function RefinanceIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
function NetWorthHistoryIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
function RatiosIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
function FireCalcIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
function EmergencyFundIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
function GoalPlannerIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
